...
export async function getServerSideProps({ params }) {
  ...
  await db.read(); // Sicherstellen, dass aktuelle Daten geladen sind

  // IDs werden als Zahl gespeichert, daher: 
  const property = db.data.sales.find(item => item.id === Number(id)) || null;
